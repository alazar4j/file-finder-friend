...
export const strings: Dict = {
  ...
  "home.contact.p": { en: "0939687239 · alazarginbaru1@gmail.com", am: "0939687239 · alazarginbaru1@gmail.com" },
  "contact.call": { en: "Call", am: "ይደውሉ" },
  "contact.wordmark": { en: "Church", am: "ቤተ ክርስቲያን" },
  "contact.openMaps": { en: "Open in Google Maps", am: "በGoogle Maps ይክፈቱ" },
  ...
  "home.give.h": { en: "Support the work of the church", am: "የቤተ ክርስቲያኑን ሥራ ይደግፉ" },
  "home.give.p": {
    en: "Your giving supports worship, ministry, outreach and care for our church family.",
    am: "ስጦታዎ አምልኮን፣ አገልግሎትን፣ ወንጌል ስርጭትንና የቤተ ክርስቲያኑን ቤተሰብ እንክብካቤ ይደግፋል።",
  },
  "home.give.bank.h": { en: "Bank information", am: "የባንክ መረጃ" },
  "home.give.bank.name": { en: "Bank", am: "ባንክ" },
  "home.give.bank.nameV": { en: "Contact the church", am: "ቤተ ክርስቲያኑን ያነጋግሩ" },
  "home.give.bank.acct": { en: "Account number", am: "የሂሳብ ቁጥር" },
  "home.give.bank.acctV": { en: "Available by phone", am: "በስልክ ይገኛል" },
  "home.give.bank.holder": { en: "Account holder", am: "የሂሳብ ባለቤት" },
